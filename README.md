...
* ![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=for-the-badge&logo=html5&logoColor=white) **HTML5:** Xây dựng cấu trúc ngữ nghĩa (Semantic HTML).
* ![CSS3](https://img.shields.io/badge/CSS3-1572B6?style=for-the-badge&logo=css3&logoColor=white) **CSS3:** Custom Properties (Variables), Flexbox, Grid Layout, Animations & Responsive Design.
...
* **Single Page Application Feel:** Chuyển đổi giữa các mục (About, Resume, Portfolio...) mượt mà không cần load lại trang.
